...
load_repo_env() {
  ...
  export OLLAMA_CODE_MODEL="${OLLAMA_CODE_MODEL:-qwen2.5-coder:7b}"
  export OLLAMA_REASON_MODEL="${OLLAMA_REASON_MODEL:-qwen2.5:7b}"
  export OLLAMA_FALLBACK_MODEL="${OLLAMA_FALLBACK_MODEL:-granite-code:8b}"
  export OLLAMA_PULL_EXPERIMENTAL="${OLLAMA_PULL_EXPERIMENTAL:-false}"
  export OLLAMA_EXPERIMENTAL_MODEL="${OLLAMA_EXPERIMENTAL_MODEL:-gpt-oss:20b}"
}
